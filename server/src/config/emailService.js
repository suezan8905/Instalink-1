...
export const sendMail = async ({
  ...
  if (!to || !subject || !intro) {
    throw createHttpError(500, "Email receipent, subject or intro is missing");
  }
  try {
    const mailGenerator = new Mailgen({
      ...
      product: {
        name: "Instashots",
        link:
          process.env.CLIENT_URL || "https://instalink-1.vercel.app/auth/login",
      },
    });
    const email = {
      body: {
    ...
    // conencting to the gmail service
